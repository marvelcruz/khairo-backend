...
const STARTER_SOPS = [
  {
    ...
    whenToUse: "Whenever a new lead enters KhairoDietClinic from the website, referral, campaign, phone or manual entry.",
    owner: "Staff",
    sortOrder: 10,
  ...
  },
  {
    ...
    steps: [
      { title: "Record the outcome", instruction: "Mark the appointment accurately so KhairoDietClinic has a reliable trigger and history.", type: "human" },
  ...
  },
  {
    ...
    whenToUse: "When KhairoDietClinic identifies inactivity, declining engagement or another defined retention-risk signal.",
    owner: "Staff",
    sortOrder: 70,
  ...
  },
  {
    ...
    whenToUse: "Whenever KhairoDietClinic creates, schedules or publishes social media content.",
    owner: "Staff",
    sortOrder: 100,
  ...
  },
  {
    ...
    whenToUse: "When a new Staff or Doctor account is being introduced to KhairoDietClinic operations.",
    owner: "Staff",
    sortOrder: 110,
    ...
    steps: [
      ...
      { title: "Create approved access", instruction: "Create only the KhairoDietClinic access required for the role and avoid sharing another person's credentials.", type: "human" },
  ...
  },
  {
    ...
    category: "management",
    purpose: "Turn KhairoDietClinic data into a short recurring operating review focused on exceptions and next actions.",
    whenToUse: "Once each week as the standard management control rhythm.",
    owner: "Staff",
    sortOrder: 120,
    tags: ["management", "kpi", "reporting"],
    steps: [
      { title: "Review the core numbers", instruction: "Review leads, bookings, active clients, payments, renewals, retention signals and unresolved work using the current KhairoDietClinic reports.", type: "automated" },
